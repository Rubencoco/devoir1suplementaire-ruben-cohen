...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnCalculerPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalculerPrimeMouseClicked
        ...
        String txtannee = txtNbAnnees.getText();
        int nbannee = Integer.parseInt(txtannee);
        double nbanneanciennete = nbannee;
        String txtBug = txtNbBugs.getText();
        int Bug = Integer.parseInt(txtBug);
        double nbBug = Bug;
        double bugcorrige=0.04;
        double total1=400;
        double total2 = 0;
        double lesannee;
        double prime = 300;
        if(txtNbBugs.getText().compareTo("")==0)
            ...
            else  if(txtNbAnnees.getText().compareTo("")==0)
            {
                ...
                if (total2 > total1)
                {
                    lblPrime.setText("Prime :" + total1 + "euros.");
                }
                else{
                    if (nbanneanciennete > 4)
                    {
                        lesannee = nbanneanciennete - 4;
                        prime = lesannee * 30 + prime;
                    }
                    total2 = nbBug*bugcorrige;
                    total2 = prime+total2;
                    lblPrime.setText("Prime :" + total2 + "euros.");
                    }
